...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="images/h2.png" class="radius-circle rotate-hover" height="50" alt="" id="flush_head" />后台管理中心</h1>
    </div>
    <div class="head-l">
        <a class="button button-little bg-green" href="../front/index.php" onclick="Logout()"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
